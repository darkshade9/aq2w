...
AWK = gawk
BASE_CFLAGS = -std=c99 -g -pedantic -W -Wall
BASE_LDFLAGS = 
BASE_LIBS = -ldl
CC = gcc
...
PACKAGE_STRING = quake2world 0.1.1
...
WINDRES = 
abs_builddir = /usr/src/aq2w
abs_srcdir = /usr/src/aq2w
...
rsync-data:
	rsync -rvz --delete $(RSYNC_REPOSITORY) /usr/local/share/quake2world
